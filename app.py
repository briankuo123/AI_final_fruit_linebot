...
def handle_postback(event):
    ...
    if postback_data.get('action')=='查詢草莓':
        ...
        if craw_fruit(0)[0] != -1:
            messages.append(TextSendMessage(text='最近價格為'+ craw_fruit(0)[0]+' ' +craw_fruit(0)[1]))
            messages.append(TextSendMessage(text=craw_fruit(0)[2]))
        ...
        if craw_fruit(1)[0] != -1:
            messages.append(TextSendMessage(text='最近價格為'+ craw_fruit(1)[0]+' ' +craw_fruit(1)[1]))
            messages.append(TextSendMessage(text=craw_fruit(1)[2]))
            messages.append(ImageSendMessage(original_content_url='price_chart.png',
                                                preview_image_url='price_chart.png'))
        else: 
            messages.append(TextSendMessage(text='無法獲取市場價格'))
        ...
        if craw_fruit(2)[0] != -1:
            messages.append(TextSendMessage(text='最近價格為'+ craw_fruit(2)[0]+' ' +craw_fruit(2)[1]))
            messages.append(TextSendMessage(text=craw_fruit(2)[2]))
            messages.append(ImageSendMessage(original_content_url='price_chart.png',
                                                preview_image_url='price_chart.png'))
        else: 
            messages.append(TextSendMessage(text='無法獲取市場價格'))
        ...
        if craw_fruit(3)[0] != -1:
            messages.append(TextSendMessage(text='最近價格為'+ craw_fruit(3)[0]+' ' +craw_fruit(3)[1]))
            messages.append(TextSendMessage(text=craw_fruit(3)[2]))
            messages.append(ImageSendMessage(original_content_url='price_chart.png',
                                                preview_image_url='price_chart.png'))
        else: 
            messages.append(TextSendMessage(text='無法獲取市場價格'))
        ...
        if craw_fruit(4)[0] != -1:
            messages.append(TextSendMessage(text='最近價格為'+ craw_fruit(4)[0]+' ' +craw_fruit(4)[1]))
            messages.append(TextSendMessage(text=craw_fruit(4)[2]))
            messages.append(ImageSendMessage(original_content_url='price_chart.png',
                                                preview_image_url='price_chart.png'))
        else: 
            messages.append(TextSendMessage(text='無法獲取市場價格'))
        ...
        if craw_fruit(5)[0] != -1:
            messages.append(TextSendMessage(text='最近價格為'+ craw_fruit(5)[0]+' ' +craw_fruit(5)[1]))
            messages.append(TextSendMessage(text=craw_fruit(5)[2]))
            messages.append(ImageSendMessage(original_content_url='price_chart.png',
                                                preview_image_url='price_chart.png'))
        else: 
            messages.append(TextSendMessage(text='無法獲取市場價格'))
        ...
        if craw_fruit(6)[0] != -1:
            messages.append(TextSendMessage(text='最近價格為'+ craw_fruit(6)[0]+' ' +craw_fruit(6)[1]))
            messages.append(TextSendMessage(text=craw_fruit(6)[2]))
            messages.append(ImageSendMessage(original_content_url='price_chart.png',
                                                preview_image_url='price_chart.png'))
        else: 
            messages.append(TextSendMessage(text='無法獲取市場價格'))
        ...
        messages.append(TextSendMessage(text='柳丁 每100克\n熱量:29千卡\n糖:2.5克\n維生素C:53.0毫克\n膳食纖維2.8毫克\n鐵質:0.6毫克'))
        if craw_fruit(7)[0] != -1:
            messages.append(TextSendMessage(text='最近價格為'+ craw_fruit(7)[0]+' ' +craw_fruit(7)[1]))
            messages.append(TextSendMessage(text=craw_fruit(7)[2]))
            messages.append(ImageSendMessage(original_content_url='price_chart.png',
                                                preview_image_url='price_chart.png'))
        else: 
            messages.append(TextSendMessage(text='無法獲取市場價格'))
        ...
        if craw_fruit(8)[0] != -1:
            messages.append(TextSendMessage(text='最近價格為'+ craw_fruit(8)[0]+' ' +craw_fruit(8)[1]))
            messages.append(TextSendMessage(text=craw_fruit(8)[2]))
            messages.append(ImageSendMessage(original_content_url='price_chart.png',
                                                preview_image_url='price_chart.png'))
        else: 
            messages.append(TextSendMessage(text='無法獲取市場價格'))
        ...
        if craw_fruit(9)[0] != -1:
            messages.append(TextSendMessage(text='最近價格為'+ craw_fruit(9)[0]+' ' +craw_fruit(9)[1]))
            messages.append(TextSendMessage(text=craw_fruit(9)[2]))
            messages.append(ImageSendMessage(original_content_url='price_chart.png',
                                                preview_image_url='price_chart.png'))
        else: 
            messages.append(TextSendMessage(text='無法獲取市場價格'))
        ...
        if craw_fruit(10)[0] != -1:
            messages.append(TextSendMessage(text='最近價格為'+ craw_fruit(10)[0]+' ' +craw_fruit(10)[1]))
            messages.append(TextSendMessage(text=craw_fruit(10)[2]))
            messages.append(ImageSendMessage(original_content_url='price_chart.png',
                                                preview_image_url='price_chart.png'))
        else: 
            messages.append(TextSendMessage(text='無法獲取市場價格'))
        ...
        if craw_fruit(11)[0] != -1:
            messages.append(TextSendMessage(text='最近價格為'+ craw_fruit(11)[0]+' ' +craw_fruit(11)[1]))
            messages.append(TextSendMessage(text=craw_fruit(11)[2]))
            messages.append(ImageSendMessage(original_content_url='price_chart.png',
                                                preview_image_url='price_chart.png'))
        else: 
            messages.append(TextSendMessage(text='無法獲取市場價格'))
        ...
        if craw_fruit(12)[0] != -1:
            messages.append(TextSendMessage(text='最近價格為'+ craw_fruit(12)[0]+' ' +craw_fruit(12)[1]))
            messages.append(TextSendMessage(text=craw_fruit(12)[2]))
            messages.append(ImageSendMessage(original_content_url='price_chart.png',
                                                preview_image_url='price_chart.png'))
        else: 
            messages.append(TextSendMessage(text='無法獲取市場價格'))
        ...
        if craw_fruit(13)[0] != -1:
            messages.append(TextSendMessage(text='最近價格為'+ craw_fruit(13)[0]+' ' +craw_fruit(13)[1]))
            messages.append(TextSendMessage(text=craw_fruit(13)[2]))
            messages.append(ImageSendMessage(original_content_url='price_chart.png',
                                                preview_image_url='price_chart.png'))
        else: 
            messages.append(TextSendMessage(text='無法獲取市場價格'))
        ...
        if craw_fruit(14)[0] != -1:
            messages.append(TextSendMessage(text='最近價格為'+ craw_fruit(14)[0]+' ' +craw_fruit(14)[1]))
            messages.append(TextSendMessage(text=craw_fruit(14)[2]))
            messages.append(ImageSendMessage(original_content_url='price_chart.png',
                                                preview_image_url='price_chart.png'))
        else: 
            messages.append(TextSendMessage(text='無法獲取市場價格'))
        ...
        if craw_fruit(15)[0] != -1:
            messages.append(TextSendMessage(text='最近價格為'+ craw_fruit(15)[0]+' ' +craw_fruit(15)[1]))
            messages.append(TextSendMessage(text=craw_fruit(15)[2]))
            messages.append(ImageSendMessage(original_content_url='price_chart.png',
                                                preview_image_url='price_chart.png'))
        else: 
            messages.append(TextSendMessage(text='無法獲取市場價格'))
        ...
        if craw_fruit(16)[0] != -1:
            messages.append(TextSendMessage(text='最近價格為'+ craw_fruit(16)[0]+' ' +craw_fruit(16)[1]))
            messages.append(TextSendMessage(text=craw_fruit(16)[2]))
            messages.append(ImageSendMessage(original_content_url='price_chart.png',
                                                preview_image_url='price_chart.png'))
        else: 
            messages.append(TextSendMessage(text='無法獲取市場價格'))
        ...
        if craw_fruit(17)[0] != -1:
            messages.append(TextSendMessage(text='最近價格為'+ craw_fruit(17)[0]+' ' +craw_fruit(17)[1]))
            messages.append(TextSendMessage(text=craw_fruit(17)[2]))
            messages.append(ImageSendMessage(original_content_url='price_chart.png',
                                                preview_image_url='price_chart.png'))
        else: 
            messages.append(TextSendMessage(text='無法獲取市場價格'))
